...
from app.modules.core.enums.type_enum import EGLOBAL_DATA_TYPE, EGLOBAL_DATA_TYPE_CONSTRAINTS, EGLOBAL_EXTRA_METAS, EMenuChildrenDisplayFlag
from app.modules.core.utils.model.base_document import BaseDocument
from app.modules.core.models.mapping_keys import CollectionKey
from typing import Annotated, List, Optional

class CfgChildrenDisplayTypeModel(BaseDocument):
    ...
    targeted_id: PydanticObjectId = Field(
        ...
        json_schema_extra=translation_meta(
            ...
            data_type={f"{EGLOBAL_DATA_TYPE.IS_STRING.value}": True},
            extra_metas={
                f"{EGLOBAL_EXTRA_METAS.UPSERT_IF_EXIST_WITH_PROPS.value}":"ref_children_display_type_id,targeted_id"
            }
        )
    )
    ...
    ref_children_display_type_id: Optional[PydanticObjectId] = Field(
        default=None,
        description="ID of targeted ref children display type",
        json_schema_extra=translation_meta(
            may_have_translation=False,
            to_be_translated_in_front=False,
            data_type={f"{EGLOBAL_DATA_TYPE.IS_SELECT.value}": True},
            extra_metas={
                f"{EGLOBAL_EXTRA_METAS.MODEL_REFERENCE.value}":f"{CollectionKey.REF_CHILDREN_DISPLAY_TYPE.value}",
            }
        )
    )
    ...
    FIELD_TRANSLATION_KEYS = FieldTranslationHelper.create_keys(
        fr={
            ...
            "ref_children_display_type_id": "Type d'affichage enfants",
        },
        en={
            "targeted_id": "Target",
            "is_default": "Default",
        ...
        ln={
            ...
            "ref_children_display_type_id": "Lolenge ya kolakisa bana",
        },
    )

    class Settings:
        name = f"{CollectionKey.CFG_CHILDREN_DISPLAY_TYPE.model_name}"
