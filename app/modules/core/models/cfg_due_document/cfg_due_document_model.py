...
class CfgDueDocumentModel(BaseDocument):
    ...
    ref_document_id: PydanticObjectId = Field(
        ...
        json_schema_extra=translation_meta(
            ...
            extra_metas={
                f"{EGLOBAL_EXTRA_METAS.MODEL_REFERENCE.value}":f"{CollectionKey.REF_DOCUMENT.value}",
            }
        )
    )
    ...
    class Settings:
        name = f"{CollectionKey.CFG_DUE_DOCUMENT.model_name}"
