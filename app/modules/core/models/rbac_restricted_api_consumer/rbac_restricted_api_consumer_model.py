...
class RbacRestrictedApiConsumerModel(BaseDocument):
    """
    This collection defines RBAC Restricted Api Consumer.
    """
    ...
    identifier: str = Field(
        ...
        description="Unique identifier for the api consumer",
    ...
    ref_api_consumer_id: PydanticObjectId = Field(
        ...,
        description="ID of targeted api consumer",
        json_schema_extra=translation_meta(
            may_have_translation=False,
            to_be_translated_in_front=False,
            data_type={f"{EGLOBAL_DATA_TYPE.IS_STRING.value}": True}
    ...
    FIELD_TRANSLATION_KEYS = FieldTranslationHelper.create_keys(
        fr={
            ...
            "ref_api_consumer_id": "ID consommateur API",
        },
        en={
            "targeted_id": "Target ID",
            "is_hidden": "Is Hidden",
            "is_locked": "Is Locked",
            "ref_api_consumer_id": "API Consumer ID",
        },
        ln={
            "targeted_id": "ID ya cible",
            "is_hidden": "Ebombami",
            "is_locked": "Ekangami",
            "ref_api_consumer_id": "ID ya mosaleli ya API",
        },
    )

    class Settings:
        name = f"{CollectionKey.RBAC_RESTRICTED_API_CONSUMER.model_name}"
