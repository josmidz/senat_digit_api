...
from app.modules.core.enums.type_enum import EMenuChildrenDisplayFlag, EGLOBAL_DATA_TYPE, EGLOBAL_DATA_TYPE_CONSTRAINTS, EGLOBAL_EXTRA_METAS
from app.modules.core.utils.model.base_document import BaseDocument
from app.modules.core.models.mapping_keys import CollectionKey
from typing import Annotated, List, Optional

class RefChildrenDisplayTypeModel(BaseDocument):
    id: Optional[PydanticObjectId] = Field(
        ...
        json_schema_extra=translation_meta(
            ...
            extra_metas={
                ...
                f"{EGLOBAL_EXTRA_METAS.DELETE_IF_NOT_USED_IN.value}": "cfgChildrenDisplaytypes",
    ...
    flag: EMenuChildrenDisplayFlag = Field(
        default=EMenuChildrenDisplayFlag.NONE,
        description="Flag",
        json_schema_extra=translation_meta(
            may_have_translation=False,
            to_be_translated_in_front=False,
            ...
            extra_metas={
                f"{EGLOBAL_EXTRA_METAS.ENUM_DATA_SOURCE.value}": "EMenuChildrenDisplayFlag",
    ...
    class Settings:
        name = f"{CollectionKey.REF_CHILDREN_DISPLAY_TYPE.model_name}"
