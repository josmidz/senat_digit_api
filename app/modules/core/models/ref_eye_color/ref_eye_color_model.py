...
class RefEyeColorModel(BaseDocument):
    ...
    description_str: str = Field(
        ...
        description="Plain-text description of the eye color",
    ...
    FIELD_TRANSLATION_KEYS = FieldTranslationHelper.create_keys(
        fr={
            "name": "Nom de la couleur des yeux",
        ...
        ln={
            "name": "Nkombo ya langi ya miso",
            "hex_code": "Code ya langi",
            "description_str": "Ndimbola",
        },
    )

    class Settings:
        name = f"{CollectionKey.REF_EYE_COLOR.model_name}"
