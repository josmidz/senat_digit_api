...
import uuid
from app.modules.core.enums.type_enum import EGLOBAL_DATA_TYPE, EGLOBAL_DATA_TYPE_CONSTRAINTS, EGLOBAL_EXTRA_METAS, EGLOBAL_DATA_TYPE_CONSTRAINTS
...
class RefReligionModel(BaseDocument):
    ...
    FIELD_TRANSLATION_KEYS = FieldTranslationHelper.create_keys(
        ...
        ln={
            "name": "Nkombo ya lingomba",
            "description_str": "Ndimbola",
        },
    )

    class Settings:
        name = f"{CollectionKey.REF_RELIGION.model_name}"
