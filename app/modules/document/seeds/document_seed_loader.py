"""Document JSON-seed bridge — same template as session_meeting/seeds/session_seed_loader.py."""
...
def load_document_permission_titles() -> list[dict[str, Any]]:
...
def load_document_apps() -> list[dict[str, Any]]:
