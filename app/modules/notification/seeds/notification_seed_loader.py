"""Notification JSON-seed bridge — same template as session_meeting/seeds/session_seed_loader.py."""
...
def load_notification_permission_titles() -> list[dict[str, Any]]:
...
def load_notification_apps() -> list[dict[str, Any]]:
