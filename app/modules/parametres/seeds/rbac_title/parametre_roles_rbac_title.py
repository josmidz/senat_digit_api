...
from app.modules.core.constants.common import ALL_ORGANIZATION_PROFIL_IN_ONE, ALL_OTHERS_ORGANIZATION_PROFIL_IN_ONE,ALL_ORGANIZATION_SUPER_ADMIN_ROLE_IN_ONE, ALL_OTHERS_ORGANIZATION_SUPER_ADMIN_ROLE_IN_ONE, SENAT_DIGIT_ADMIN_WEB_IN_ONE, SYSTEM_ORGANIZATION_PROFIL_IN_ONE, SYSTEM_SUPER_ADMIN_ROLE_IN_ONE, TEST_ADMIN_ROLE_IN_ONE, TEST_PROFIL_IN_ONE

PARAMETRE_ROLES_PERMISSION_RBAC_TITLE_DB = [
    {
        'flag': "settings_loading_organization_global_roles",
        "label": "Chargement des rôles",
        "is_link_deleted": False,
        "description_str": "cette permission permet à la personne qui l'a de pouvoir accéder et voir les rôles",
        "core_seeds": {
                    ...
                    "fetch_url": [
                        {
                            ...
                            "menu_flag": "apps_settings_organization_rbac_roles",
    ...
    {
        'flag': "settings_creating_organization_global_roles",
        "label": "Création d'un nouveau rôle",
        "is_link_deleted": False,
        "description_str": "cette permission permet à la personne qui l'a de pouvoir accéder et de créer un nouveau rôle",
        "core_seeds": {
           "restricted_profil_list": [
                *SYSTEM_ORGANIZATION_PROFIL_IN_ONE,
            ],
    ...
    {
        'flag': "settings_updating_organization_global_roles",
        "label": "Mise à jour d'un rôle",
        "is_link_deleted": False,
        "description_str": "cette permission permet à la personne qui l'a de pouvoir accéder et de mettre à jour un rôle",
        "core_seeds": {
            "restricted_profil_list": [
                *SYSTEM_ORGANIZATION_PROFIL_IN_ONE,
            ],
    ...
    {
        'flag': "settings_updating_roles_permissions_of_organization_global_roles_inner_roles",
        "label": "Modification des permissions d'un rôle",
        "is_link_deleted": False,
        "description_str": "cette permission permet à la personne qui l'a de pouvoir accéder et de modifier les permissions d'un rôle",
        "core_seeds": {
            "restricted_profil_list": [
                *SYSTEM_ORGANIZATION_PROFIL_IN_ONE,
            ],
    ...
    {
        'flag': "settings_deleting_organization_global_roles",
        "label": "Suppression d'un rôle",
        "is_link_deleted": False,
        "description_str": "cette permission permet à la personne qui l'a de pouvoir accéder et de supprimer un rôle",
        "core_seeds": {
            "restricted_profil_list": [
                *SYSTEM_ORGANIZATION_PROFIL_IN_ONE,
            ],
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    ...
                    "delete_processing_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": "/api/v1/static/data/org/delete-role",
                            "is_sudo_action": True,
                            "is_sudo_group_action": True,
                            "menu_flag": "apps_settings_organization_rbac_roles",
                            "is_parent_field_name": False,
