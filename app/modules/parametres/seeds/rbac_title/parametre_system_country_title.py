...
APP_SYSTEM_COUNTRY_PERMISSION_RBAC_TITLE_DB = [
    {
        'flag': "app_loading_of_system_country",
        "label": "Chargement des pays système (app)",
        "core_seeds": {
            ...
            "rbac_collection_meta_data_obj": {
                ...
                "collection_meta_data_to_menus": {
                    "fetch_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": "/api/v1/system-countries/countries/fetch/system-countries",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "apps_settings_organization_systems_countries_page",
                            "is_parent_field_name": False,
                            "is_link_deleted": False,
                        }, 
                        {
                            "hard_code_flag": "fetch_entities_fetch_url",
                            "rbac_endpoint": "/api/v1/system-countries/countries/fetch/entities",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "apps_settings_organization_systems_countries_page",
                            "is_parent_field_name": False,
                        ...
                        { 
                            "hard_code_flag": "fetch_application_groups_fetch_url",
    ...
    {
        'flag': "settings_update_of_system_country",
        "label": "Mise à jour d'un pays",
        "core_seeds": {
            "restricted_profil_list": [
                *TEST_PROFIL_IN_ONE,
            ],
            ...
            "rbac_collection_meta_data_obj": {
                ...
                "collection_meta_data_to_menus": {
                    "update_processing_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": f"/api/v1/generic/update/{CollectionKey.CFG_SYSTEM_COUNTRY.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "apps_settings_organization_systems_countries_page",
                            "is_parent_field_name": False,
                    ...
                    "update_head_process_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": f"/api/v1/generic/update-head/{CollectionKey.CFG_SYSTEM_COUNTRY.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "apps_settings_organization_systems_countries_page",
                            "is_parent_field_name": False,
    ...
    {
        'flag': "app_system_country_creation",
    ...
    {
        'flag': "settings_deleting_of_system_countries",
        "label": "Suppression des pays",
        "core_seeds": {
            "restricted_profil_list": [
                *TEST_PROFIL_IN_ONE,
            ],
