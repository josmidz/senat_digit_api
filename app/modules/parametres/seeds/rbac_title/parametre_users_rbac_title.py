...
from app.modules.core.constants.common import ALL_ORGANIZATION_PROFIL_IN_ONE, ALL_OTHERS_ORGANIZATION_PROFIL_IN_ONE,ALL_ORGANIZATION_SUPER_ADMIN_ROLE_IN_ONE, ALL_OTHERS_ORGANIZATION_SUPER_ADMIN_ROLE_IN_ONE, SENAT_DIGIT_ADMIN_WEB_IN_ONE, SYSTEM_ORGANIZATION_PROFIL_IN_ONE, SYSTEM_SUPER_ADMIN_ROLE_IN_ONE


PARAMETRE_USERS_PERMISSION_RBAC_TITLE_DB = [
    {
        'flag': "settings_loading_users_out_of_org_chart",
        "label": "[Params] Chargement des utilisateurs",
        "core_seeds": {
                ...
                "collection_meta_data_to_menus": {
                    ...
                    "fetch_one_info_url": [ 
                        ...
                        },
                        {
                            ...
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "apps_settings_organization_user_detail_outof_org_chart",
                            "is_parent_field_name": False,
                            "is_link_deleted": False,
                        },
                    ],
    ...
    {
        'flag': "settings_loading_users_out_of_org_chart_privileges",
        "label": "[Params] Chargement des privilèges des utilisateurs",
        "core_seeds": {
            "restricted_profil_list": [
                *SYSTEM_ORGANIZATION_PROFIL_IN_ONE,
            ],
    ...
    {
        'flag': "settings_deleting_users_out_of_org_chart_privileges",
    ...
    {
        'flag': "settings_loading_users_out_of_org_chart_login_history",
    ...
    # START USER DEVICES
    {
        'flag': "settings_loading_users_out_of_org_chart_devices",
    ...
    {
        'flag': "settings_deleting_users_out_of_org_chart_devices",
    ...
    {
        'flag': "settings_update_users_out_of_org_chart_devices_lock_unlock",
    ...
    {
        'flag': "settings_update_users_out_of_org_chart_allowed_devices_count",
    ...
    {
        'flag': "settings_update_users_out_of_org_chart_devices_validations",
    ...
    # START STANDALONE USER DEVICES PAGE (apps_settings_organization_users_devices)
    {
        'flag': "settings_loading_users_devices",
        ...
        "core_seeds": {
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    "fetch_url": [ 
                        {
                            "hard_code_flag": "fetch_all_user_devices_url",
                            "rbac_endpoint": f"/api/v1/generic/org/fetch/{CollectionKey.CFG_USER_DEVICE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "apps_settings_organization_users_devices",
                            "is_parent_field_name": False,
                            "is_link_deleted": False,
                        }
                    ], 
    ...
    {
        'flag': "settings_validate_users_devices",
        "label": "Valider les terminaux des utilisateurs",
        "core_seeds": {
            "restricted_profil_list": [
                *ALL_ORGANIZATION_PROFIL_IN_ONE,
                ...
                "action_to_menus": [
                    {
                        ...
                        "action_flag": ERbacActionFlag.TABLE_ACTION_UPDATE.value,
                        "action_is_standalone": True,
                        "action_hard_code_flag": 'custom_all_user_device_action_validation_flag',
                        "action_label": 'Valider'
                    }
                ],
                "action_to_apps": []
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    "update_processing_url": [
                        {
                            "hard_code_flag": "validate_all_user_device_url",
                            "rbac_endpoint": f"/api/v1/generic/org/update/{CollectionKey.CFG_USER_DEVICE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "apps_settings_organization_users_devices",
    ...
    {
        'flag': "settings_lock_unlock_users_devices",
        "label": "Bloquer/ Débloquer les terminaux des utilisateurs",
        "core_seeds": {
            "restricted_profil_list": [
                *ALL_ORGANIZATION_PROFIL_IN_ONE,
                ...
                "action_to_menus": [
                    {
                        ...
                        "action_flag": ERbacActionFlag.COMMON_LOCK_ACTION.value,
                        "action_is_standalone": True,
                        "action_hard_code_flag": 'custom_all_user_device_action_lock_unlock_flag',
                        "action_label": 'Bloquer/ Débloquer'
                    }
                ],
                "action_to_apps": []
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    "update_processing_url": [
                        {
                            "hard_code_flag": "lock_unlock_all_user_device_url",
                            "rbac_endpoint": f"/api/v1/generic/org/update/{CollectionKey.CFG_USER_DEVICE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "apps_settings_organization_users_devices",
    ...
    {
        'flag': "settings_deleting_users_devices",
        ...
        "core_seeds": {
                ...
                "action_to_menus": [
                    {
                        "menu_flag": "apps_settings_organization_users_devices",
                        "action_flag": ERbacActionFlag.TABLE_ACTION_DELETE.value,
                        "action_hard_code_flag": 'custom_all_user_device_action_delete_flag',
                        "action_is_standalone": False,
                        "action_label": 'Supprimer'
                    }
                ],
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    "delete_processing_url": [
                        {
                            "hard_code_flag": "delete_all_user_device_url",
                            "rbac_endpoint": f"/api/v1/generic/org/hard-delete/{CollectionKey.CFG_USER_DEVICE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "apps_settings_organization_users_devices",
    ...
    # END STANDALONE USER DEVICES PAGE


    {
        'flag': "settings_org_creating_organization_users_out_of_org_chart",
    ...
    {
        'flag': "settings_org_updating_organization_users_in_all_or_under_chart",
        "label": "Mise à jour d'un utilisateur hors organigramme"
    },
    {
        'flag': "settings_org_deleting_organization_users_in_all_outof_chart",
        "label": "Suppression d'un utilisateur hors organigramme"
    },
    {
        'flag': "settings_org_generating_organization_users_password_reset_link",
