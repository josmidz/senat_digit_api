"""Presence JSON-seed bridge — same template as session_meeting/seeds/session_seed_loader.py."""
...
def load_presence_permission_titles() -> list[dict[str, Any]]:
    ...
    for entry in raw.get("permission_titles", []):
        ...
        out.append({
            ...
            "_status": entry.get("_status"),
        })
    return out


def load_presence_apps() -> list[dict[str, Any]]:
