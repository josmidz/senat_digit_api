...
from app.modules.core.constants.common import SENAT_DIGIT_ADMIN_WEB_IN_ONE, SYSTEM_SUPER_ADMIN_ROLE_IN_ONE, TRANS_ADMIN_ROLE_IN_ONE, MAIN_PROFILE_IN_ONE, TRANS_RH_ROLE_IN_ONE

RH_GRADE_PERMISSION_RBAC_TITLE_DB = [
    {
        'flag': "apps_ressources_humaines_loading_organization_global_grades",
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    "fetch_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": f"/api/v1/generic/org/fetch/{CollectionKey.CFG_GRADE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "ressources_humaines_single_organization_grades",
    ...
    {
        'flag': "apps_ressources_humaines_creating_organization_global_grades",
        "label": "Création d'un nouveau grade",
        "core_seeds": {
            "restricted_profil_list": [
                *MAIN_PROFILE_IN_ONE,
            ],
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    "create_processing_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": f"/api/v1/generic/org/add/{CollectionKey.CFG_GRADE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "ressources_humaines_single_organization_grades",
                            "is_parent_field_name": False,
                    ...
                    "create_head_process_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": f"/api/v1/generic/org/head/{CollectionKey.CFG_GRADE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "ressources_humaines_single_organization_grades",
                            "is_parent_field_name": False,
    ...
    {
        'flag': "apps_ressources_humaines_updating_organization_global_grades",
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    "update_processing_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": f"/api/v1/generic/org/update/{CollectionKey.CFG_GRADE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "ressources_humaines_single_organization_grades",
                            "is_parent_field_name": False,
                    ...
                    "update_head_process_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": f"/api/v1/generic/org/update-head/{CollectionKey.CFG_GRADE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "ressources_humaines_single_organization_grades",
                            "is_parent_field_name": False,
    ...
    {
        'flag': "apps_ressources_humaines_deleting_organization_global_grades",
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    "delete_processing_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": f"/api/v1/generic/org/hard-delete/{CollectionKey.CFG_GRADE.value}",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "ressources_humaines_single_organization_grades",
                            "is_parent_field_name": False,
