...
class DelegatedValidatorsController(DebugService, ResponseService, ConverterService, AuthenticatedService):
    ...
    async def fetch_delegated_validators(
        ...
        try:
            ...
            format_error = format_exception("error fetch_delegated_validators ", e)
            self.app_debug_print(
                f"Error in fetch_delegated_validators: > 1 {format_error} {exception_line_info(e)}", True
            )
