...
class CfgRlsSetupModel(BaseDocument):
    ...
    class Settings:
        name = f"{CollectionKey.CFG_RLS_SETUP.model_name}"
    ...
    async def get_formated_data(self,lang:str="fr",output: FormatedOutPut = FormatedOutPut.MINIMAL) -> dict:
        return {
            ...
            "strict_mode_message":self.strict_mode_message,
            "no_strict_mode_message":self.no_strict_mode_message,
        }
