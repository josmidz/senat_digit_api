...
SECURITY_VALIDATION_DELEGATED_VALIDATORS_PERMISSION_RBAC_TITLE_DB = [
        {
            'flag': "loading_permission_delegated_validators",
            'is_default': False,
            "label": "Chargement des validateurs délégués d'une permission ( dans validateurs délégués)",
            "core_seeds": {
                ...
                "sys_menus_list": [
                    ...
                    {
                        "flag": "security_validations_delegated_validators_page",
                        "is_link_activated": True,
                        "is_link_hidden": False,
                        "is_link_locked": False,
                        "is_link_deleted": False,
                ...
                "rbac_collection_meta_data_obj": {
                    ...
                    "collection_meta_data_to_menus": {
                        "fetch_url": [
                            {
                                "hard_code_flag": "main",
                                "rbac_endpoint": "/api/v1/securities/validations/delegated-validators/fetch/delegated-validators",
                                "is_sudo_action": False,
                                "is_sudo_group_action": False,
                                "menu_flag": "security_validations_delegated_validators_page",
        ...
        },
        {
            ...
            'is_default': False,
            "label": "Activer/Désactiver le sudo action d'une permission ( dans validateurs délégués)",
            "core_seeds": {
                "restricted_profil_list": [
                    *ALL_ORGANIZATION_PROFIL_IN_ONE
                ],
        ...
        {
            'flag': "adding_user_account_from_permission_delegated_validator_group",
            'is_default': False,
            "label": "Ajouter un utilisateur/groupe dans un groupe des validateurs délégués d'une permission",
            "core_seeds": {
                "restricted_profil_list": [
                    *ALL_ORGANIZATION_PROFIL_IN_ONE
                ],
        ...
        {
            'flag': "removing_user_account_from_permission_delegated_validator_group",
            'is_default': False,
            "label": "Retirer un utilisateur/groupe d'un groupe des validateurs délégués d'une permission",
            "core_seeds": {
                "restricted_profil_list": [
                    *ALL_ORGANIZATION_PROFIL_IN_ONE
                ],
