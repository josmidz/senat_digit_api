...
SECURITY_VALIDATION_GLOBAL_VALIDATORS_RBAC_TITLE_DB = [
    {
        'flag': "loading_global_validators",
                'is_default': False,
                ...
                "core_seeds": {
                    ...
                    "sys_menus_list": [
                        ...
                        {
                            "flag": "security_validations_global_validators_page",
                            "is_link_activated": True,
                            "is_link_hidden": False,
                            "is_link_locked": False,
                            "is_link_deleted": False,
                    ...
                    "rbac_collection_meta_data_obj": {
                        "collection_meta_data_to_menus": {
                            "fetch_url": [
                                {
                                    "hard_code_flag": "main",
                                    "rbac_endpoint": "/api/v1/securities/validations/global-validators/fetch/global-validators",
    ...
    {
        'flag': "adding_user_account_from_global_validator_group",
                'is_default': False,
                            ...
                            "fetch_url": [
                                {
                                    ...
                                    "rbac_endpoint": "/api/v1/securities/validations/global-validators/fetch/available-groups",
                                    "is_sudo_action": False,
                                    "is_sudo_group_action": False,
                                    "menu_flag": "security_validations_global_validators_page",
                                    "is_parent_field_name": False,
                                ...
                                },
                                {
                                    ...
                                    "rbac_endpoint": "/api/v1/securities/validations/global-validators/fetch/available-users",
                                    "is_sudo_action": False,
                                    "is_sudo_group_action": False,
                                    "menu_flag": "security_validations_global_validators_page",
                                    "is_parent_field_name": False,
    ...
    {
        'flag': "removing_user_account_from_global_validator_group",
                'is_default': False,
                    ...
                    "rbac_collection_meta_data_obj": {
                        "collection_meta_data_to_menus": {
                            ...
                            "delete_processing_url": [
                                ...
                                {
                                    "hard_code_flag": "main",
                                    "rbac_endpoint": f"/api/v1/generic/hard-delete/{CollectionKey.CFG_SUDO_ACTION_ACCESS.value}",
                                    "is_sudo_action": True,
                                    "is_sudo_group_action": False,
                                    "menu_flag": "security_validations_global_validators_page",
                                    "is_parent_field_name": False,
