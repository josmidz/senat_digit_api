...
VALIDATION_SUDO_ACTION_OVERVIEW_PERMISSION_RBAC_DB = [
    {
        'flag': "validation_sudo_action_overview_loading_of_vehicles",
        ...
        "core_seeds": {
            ...
            "sys_menus_list": [
                ...
                {
                    "flag": "security_validations_overview_page",
                    "is_link_activated": True,
                    "is_link_hidden": False,
                    "is_link_locked": False,
                    "is_link_deleted": False,
            ...
            "rbac_collection_meta_data_obj": {
                "collection_meta_data_to_menus": {
                    "fetch_url": [
                        {
                            "hard_code_flag": "main",
                            "rbac_endpoint": "/api/v1/securities/validations/sudo-actions/fetch/sudo-actions-overview",
                            "is_sudo_action": False,
                            "is_sudo_group_action": False,
                            "menu_flag": "security_validations_overview_page",
