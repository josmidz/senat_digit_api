...
# Execute the dummy seed script and log output
SEED_OUT_LOG="$LOGS_DIR/dummy_seed_local_out.log"
SEED_ERR_LOG="$LOGS_DIR/dummy_seed_local_err.log"
echo "Running dummy seed script..."
